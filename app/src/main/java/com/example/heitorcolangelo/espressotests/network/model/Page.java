...
public class Page implements Parcelable {
    ...
    @Override
    public void writeToParcel(Parcel dest, int flags) {dest.writeTypedList(this.results);}

    public Page() {}

    protected Page(Parcel in) {this.results = in.createTypedArrayList(UserVO.CREATOR);}
